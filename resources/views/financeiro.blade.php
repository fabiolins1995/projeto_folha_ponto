...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Registro financeiro</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="exampleInputEmail1" placeholder="Equipe">
                    <option value=""></option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Função</label>
                    <select class="form-control" id="exampleInputEmail1" placeholder="Função">
                    <option value=""></option>
                    </select>
                  </div>
                </div>
